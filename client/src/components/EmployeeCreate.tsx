...
export default function EmployeeCreate() {
	...
	const handleFormSubmit = React.useCallback(async () => {
		...
		try {
			await createEmployee(formValues as Omit<MaintenanceRecord, 'id'>);
			notifications.show('Service created successfully.', {
				severity: 'success',
			...
			notifications.show(
				`Failed to create service. Reason: ${(createError as Error).message}`,
				{
					severity: 'error',
					autoHideDuration: 3000
				}
